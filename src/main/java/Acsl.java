...
public class Acsl {
  ...
  /***
   * Returns the BigInteger representation of the sum of all non-overlapping n-long substrings of
   * number once converted to StringBuilder.
   * 
   * @param number
   *          number that is divided into n-long pieces
   * @param n
   *          length of substring
   * @return the BigInteger representation of the sum of all non-overlapping n-long substrings of
   *         number once converted to StringBuilder.
   */
